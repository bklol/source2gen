...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hRemapLineStart; // 0x4f8        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CBaseEntity> m_hRemapLineEnd; // 0x4fc        
        // metadata: MNetworkEnable
        ...
        CNetworkUtlVectorBase<CHandle<server::CBaseEntity>> m_hOutputEntities; // 0x538        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CBasePlayerPawn> m_hUsingPlayer; // 0x588        
        ...
        CEntityOutputTemplate<float> m_Position; // 0x5c0        
        ...
        CEntityOutputTemplate<float> m_PositionDelta; // 0x5e8        
