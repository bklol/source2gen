...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::CEntityIOOutput m_OnStopped; // 0x790        
        entity2::CEntityIOOutput m_OnStarted; // 0x7b8        
        entity2::CEntityIOOutput m_OnReachedStart; // 0x7e0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x83a[0xa]; // 0x83a
    ...
    static_assert(sizeof(CFuncRotating) == 0x878);
};
