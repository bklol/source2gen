...
namespace source2sdk::server
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeCTextureBase> m_hPositionKeys; // 0x798        
        // metadata: MNetworkEnable
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeCTextureBase> m_hRotationKeys; // 0x7a0        
        // metadata: MNetworkEnable
