...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CCSPlayerPawn> m_PlayerDamager; // 0x28        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CCSPlayerPawn> m_PlayerRecipient; // 0x2c        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CCSPlayerController> m_hPlayerControllerDamager; // 0x30        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CCSPlayerController> m_hPlayerControllerRecipient; // 0x34        
        // metadata: MNetworkEnable
