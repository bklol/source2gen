...
namespace source2sdk::server
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition> m_iEffectIndex; // 0x528        
        // metadata: MNetworkEnable
        ...
        CNetworkUtlVectorBase<float> m_PathNodes_RadiusScale; // 0x5a8        
