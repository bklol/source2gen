...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CCSPlayerPawn> m_leader; // 0x1ac        
        ...
        CHandle<server::CBaseEntity> m_taskEntity; // 0x4dc        
        ...
        CHandle<server::CCSPlayerPawn> m_enemy; // 0x6110        
        ...
        CHandle<server::CCSPlayerPawn> m_bomber; // 0x6348        
        ...
        CHandle<server::CCSPlayerPawn> m_closestVisibleFriend; // 0x6350        
        ...
        CHandle<server::CCSPlayerPawn> m_closestVisibleHumanFriend; // 0x6354        
        ...
        CHandle<server::CCSPlayerPawn> m_attacker; // 0x6368        
        ...
        CHandle<server::CCSPlayerPawn> m_radioSubject; // 0x6524        
