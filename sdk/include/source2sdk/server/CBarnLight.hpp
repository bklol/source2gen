...
namespace source2sdk::server
{
    ...
    public:
        ...
        CNetworkUtlVectorBase<CHandle<server::CBaseModelEntity>> m_LightStyleTargets; // 0x800        
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeCTextureBase> m_hLightCookie; // 0x8d8        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "RenderingChanged"
        ...
        CNetworkUtlVectorBase<uint16_t> m_VisClusters; // 0xa90        
