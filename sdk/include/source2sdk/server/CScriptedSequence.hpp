...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseAnimGraph> m_hForcedTarget; // 0x584        
        ...
        CHandle<server::CBaseEntity> m_hInteractionMainEntity; // 0x7f0        
