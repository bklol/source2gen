...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CTonemapController2> m_hTonemapController; // 0xa0        
        ...
        CNetworkUtlVectorBase<CHandle<server::CPostProcessingVolume>> m_PostProcessingVolumes; // 0x120        
        ...
        CUtlVector<CHandle<server::CEnvSoundscapeTriggerable>> m_hTriggerSoundscapeList; // 0x158        
    };
    #pragma pack(pop)
