...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hViewTarget; // 0x9c8        
        ...
        CHandle<server::CBaseEntity> m_hViewTargetAngles; // 0x9cc        
        ...
        CHandle<server::CBaseEntity> m_hViewPosition; // 0x9d8        
        ...
        CHandle<server::CBaseEntity> m_hViewPositionMover; // 0x9dc        
