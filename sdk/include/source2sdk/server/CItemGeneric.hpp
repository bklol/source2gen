...
namespace source2sdk::server
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition> m_hSpawnParticleEffect; // 0xaa0        
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition> m_hPickupParticleEffect; // 0xac0        
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition> m_hTimeoutParticleEffect; // 0xad8        
        ...
        CHandle<server::CBaseFilter> m_hPickupFilter; // 0xaf8        
        ...
        CHandle<server::CItemGenericTriggerHelper> m_hTriggerHelper; // 0xbe8        
