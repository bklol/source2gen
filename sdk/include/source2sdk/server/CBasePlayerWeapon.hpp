...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTick_t m_nNextPrimaryAttackTick; // 0xd30        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalWeaponExclusive"
        float m_flNextPrimaryAttackTickRatio; // 0xd34        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalWeaponExclusive"
        entity2::GameTick_t m_nNextSecondaryAttackTick; // 0xd38        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalWeaponExclusive"
        ...
        entity2::CEntityIOOutput m_OnPlayerUse; // 0xd50        
    ...
    static_assert(sizeof(CBasePlayerWeapon) == 0xd78);
};
