...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBasePlayerPawn> m_hPawn; // 0x520        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CBasePlayerController> m_hSplitOwner; // 0x52c        
        ...
        CUtlVector<CHandle<server::CBasePlayerController>> m_hSplitScreenPlayers; // 0x530        
