...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hRagdollSource; // 0xa20        
        ...
        CHandle<server::CBaseEntity> m_hDamageEntity; // 0xa2c        
        // m_hKiller has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        CHandle<server::CBaseEntity> m_hKiller; // 0xa30        
        // m_hPhysicsAttacker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        CHandle<server::CBasePlayerPawn> m_hPhysicsAttacker; // 0xa34        
