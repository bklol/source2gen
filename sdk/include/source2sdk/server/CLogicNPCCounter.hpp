...
namespace source2sdk::server
{
    ...
    public:
        ...
        CEntityOutputTemplate<float> m_OnFactorAll; // 0x530        
        ...
        CEntityOutputTemplate<float> m_OnMinPlayerDistAll; // 0x558        
        ...
        CEntityOutputTemplate<float> m_OnFactor_1; // 0x5d0        
        ...
        CEntityOutputTemplate<float> m_OnMinPlayerDist_1; // 0x5f8        
        ...
        CEntityOutputTemplate<float> m_OnFactor_2; // 0x670        
        ...
        CEntityOutputTemplate<float> m_OnMinPlayerDist_2; // 0x698        
        ...
        CEntityOutputTemplate<float> m_OnFactor_3; // 0x710        
        ...
        CEntityOutputTemplate<float> m_OnMinPlayerDist_3; // 0x738        
