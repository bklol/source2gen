...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hZoomOwner; // 0x180        
        ...
        CUtlVector<CHandle<server::CBaseEntity>> m_hTriggerFogList; // 0x188        
        ...
        CHandle<server::CBaseEntity> m_hLastFogTrigger; // 0x1a0        
