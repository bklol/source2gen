...
namespace source2sdk::server
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIMaterial2> m_hBaseMaterial; // 0x7a8        
        // metadata: MNetworkEnable
        // m_nHaloIndex has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        CStrongHandle<resourcesystem::InfoForResourceTypeIMaterial2> m_nHaloIndex; // 0x7b0        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CBaseEntity> m_hAttachEntity[10]; // 0x7c0        
        // metadata: MNetworkEnable
        ...
        CHandle<server::CBaseEntity> m_hEndEntity; // 0x828        
