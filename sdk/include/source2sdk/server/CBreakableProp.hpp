...
namespace source2sdk::server
{
    ...
    public:
        ...
        CEntityOutputTemplate<float> m_OnHealthChanged; // 0xa58        
        ...
        CHandle<server::CBaseEntity> m_hBreaker; // 0xad0        
        ...
        CHandle<server::CBasePlayerPawn> m_hPhysicsAttacker; // 0xb28        
