...
namespace source2sdk::server
{
    ...
    public:
        ...
        CNetworkUtlVectorBase<CHandle<server::CBasePlayerController>> m_aPlayerControllers; // 0x4e0        
        // metadata: MNetworkEnable
        ...
        CNetworkUtlVectorBase<CHandle<server::CBasePlayerPawn>> m_aPlayers; // 0x4f8        
        // metadata: MNetworkEnable
