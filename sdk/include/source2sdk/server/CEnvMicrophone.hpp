...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hMeasureTarget; // 0x4e4        
        ...
        CHandle<server::CBaseEntity> m_hSpeaker; // 0x500        
        ...
        CHandle<server::CBaseFilter> m_hListenFilter; // 0x518        
        ...
        CEntityOutputTemplate<float> m_SoundLevel; // 0x520        
