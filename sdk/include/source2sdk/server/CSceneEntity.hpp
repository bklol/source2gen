...
namespace source2sdk::server
{
    ...
    public:
        ...
        CHandle<server::CBaseEntity> m_hWaitingForThisResumeScene; // 0x588        
        ...
        CNetworkUtlVectorBase<CHandle<server::CBaseFlex>> m_hActorList; // 0x598        
        ...
        CUtlVector<CHandle<server::CBaseEntity>> m_hRemoveActorList; // 0x5b0        
        ...
        CHandle<server::CSceneEntity> m_hInterruptScene; // 0x9d8        
        ...
        CUtlVector<CHandle<server::CSceneEntity>> m_hNotifySceneCompletion; // 0x9e8        
        ...
        CUtlVector<CHandle<server::CSceneListManager>> m_hListManagers; // 0xa00        
