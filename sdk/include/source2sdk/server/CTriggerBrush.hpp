...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::CEntityIOOutput m_OnStartTouch; // 0x790        
        entity2::CEntityIOOutput m_OnEndTouch; // 0x7b8        
        entity2::CEntityIOOutput m_OnUse; // 0x7e0        
    ...
    static_assert(sizeof(CTriggerBrush) == 0x810);
};
