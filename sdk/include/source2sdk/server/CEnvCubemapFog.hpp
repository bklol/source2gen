...
namespace source2sdk::server
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIMaterial2> m_hSkyMaterial; // 0x510        
        // metadata: MNetworkEnable
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeCTextureBase> m_hFogCubemapTexture; // 0x520        
        // metadata: MNetworkEnable
