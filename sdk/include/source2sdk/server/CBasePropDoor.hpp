...
namespace source2sdk::server
{
    ...
    public:
        ...
        CUtlVector<CHandle<server::CBasePropDoor>> m_hDoorList; // 0xc70        
        ...
        CHandle<server::CBaseEntity> m_hBlocker; // 0xcb0        
        ...
        CHandle<server::CBaseEntity> m_hActivator; // 0xce8        
        ...
        CHandle<server::CBasePropDoor> m_hMaster; // 0xd50        
