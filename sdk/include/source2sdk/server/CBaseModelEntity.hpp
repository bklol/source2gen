...
namespace source2sdk::server
{
    ...
    public:
        ...
        CUtlVectorEmbeddedNetworkVar<server::EntityRenderAttribute_t> m_vecRenderAttributes; // 0x5a8        
        // metadata: MNetworkEnable
        ...
        CNetworkUtlVectorBase<CHandle<server::CBaseModelEntity>> m_ConfigEntitiesToPropagateMaterialDecalsTo; // 0x748        
        // metadata: MNetworkEnable
