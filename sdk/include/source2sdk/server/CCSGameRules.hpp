...
namespace source2sdk::server
{
    ...
    public:
        ...
        CUtlVector<int32_t> m_arrSelectedHostageSpawnIndices; // 0xd88        
        ...
        CUtlVector<int32_t> m_nEndMatchTiedVotes; // 0xdb0        
        ...
        CUtlVector<server::SpawnPoint*> m_CTSpawnPointsMasterList; // 0xf40        
        ...
        CUtlVector<server::SpawnPoint*> m_TerroristSpawnPointsMasterList; // 0xf58        
        ...
        CUtlVector<server::SpawnPoint*> m_CTSpawnPoints; // 0xf88        
        ...
        CUtlVector<server::SpawnPoint*> m_TerroristSpawnPoints; // 0xfa0        
        ...
        CHandle<server::CBaseEntity> m_hPlayerResource; // 0x1570        
        ...
        CUtlVector<int32_t> m_arrTeamUniqueKillWeaponsMatch[4]; // 0x1710        
