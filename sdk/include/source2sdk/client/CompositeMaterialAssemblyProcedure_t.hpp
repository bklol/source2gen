...
namespace source2sdk::client
{
    ...
    public:
        ...
        CUtlVector<client::CompositeMaterialMatchFilter_t> m_vecMatchFilters; // 0x18        
        ...
        CUtlVector<client::CompositeMaterialInputContainer_t> m_vecCompositeInputContainers; // 0x30        
        ...
        CUtlVector<client::CompMatPropertyMutator_t> m_vecPropertyMutators; // 0x48        
    };
    #pragma pack(pop)
