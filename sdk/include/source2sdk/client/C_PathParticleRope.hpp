...
namespace source2sdk::client
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition> m_iEffectIndex; // 0x5b0        
        // metadata: MNetworkEnable
        ...
        C_NetworkUtlVectorBase<float> m_PathNodes_RadiusScale; // 0x630        
