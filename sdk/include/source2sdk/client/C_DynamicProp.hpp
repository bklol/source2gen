...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1112[0x6]; // 0x1112
        entity2::CEntityIOOutput m_pOutputAnimBegun; // 0x1118        
        entity2::CEntityIOOutput m_pOutputAnimOver; // 0x1140        
        entity2::CEntityIOOutput m_pOutputAnimLoopCycleOver; // 0x1168        
        entity2::CEntityIOOutput m_OnAnimReachedStart; // 0x1190        
        entity2::CEntityIOOutput m_OnAnimReachedEnd; // 0x11b8        
        CUtlSymbolLarge m_iszIdleAnim; // 0x11e0        
        client::AnimLoopMode_t m_nIdleAnimLoopMode; // 0x11e8        
        ...
        [[maybe_unused]] std::uint8_t pad_0x11f2[0x2]; // 0x11f2
        ...
        [[maybe_unused]] std::uint8_t pad_0x1224[0x4];
    ...
    static_assert(sizeof(C_DynamicProp) == 0x1228);
};
