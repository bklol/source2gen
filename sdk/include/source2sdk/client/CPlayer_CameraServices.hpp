...
namespace source2sdk::client
{
    ...
    public:
        ...
        CHandle<client::C_TonemapController2> m_hTonemapController; // 0xa0        
        ...
        C_NetworkUtlVectorBase<CHandle<client::C_PostProcessingVolume>> m_PostProcessingVolumes; // 0x120        
        ...
        CHandle<client::C_FogController> m_hOldFogController; // 0x1a8        
        ...
        CHandle<client::C_PostProcessingVolume> m_hActivePostProcessingVolume; // 0x1f4        
