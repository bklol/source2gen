...
namespace source2sdk::client
{
    ...
    public:
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeIMaterial2> m_hSkyMaterial; // 0x598        
        // metadata: MNetworkEnable
        ...
        CStrongHandle<resourcesystem::InfoForResourceTypeCTextureBase> m_hFogCubemapTexture; // 0x5a8        
        // metadata: MNetworkEnable
