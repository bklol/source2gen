...
namespace source2sdk::client
{
    ...
    public:
        ...
        C_NetworkUtlVectorBase<CHandle<client::CBasePlayerController>> m_aPlayerControllers; // 0x568        
        // metadata: MNetworkEnable
        ...
        C_NetworkUtlVectorBase<CHandle<client::C_BasePlayerPawn>> m_aPlayers; // 0x580        
        // metadata: MNetworkEnable
