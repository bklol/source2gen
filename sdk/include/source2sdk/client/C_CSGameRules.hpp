...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xcd1[0xa7]; // 0xcd1
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xd7e[0x1a]; // 0xd7e
        // metadata: MNetworkEnable
        // metadata: MNetworkPolymorphic
        client::CCSGameModeRules* m_pGameModeRules; // 0xd98        
        // metadata: MNetworkEnable
        client::C_RetakeGameRules m_RetakeRules; // 0xda0        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnMatchEndCountChanged"
        uint8_t m_nMatchEndCount; // 0xeb8        
        [[maybe_unused]] std::uint8_t pad_0xeb9[0x3]; // 0xeb9
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xefd[0x3]; // 0xefd
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xf0d[0x400b]; // 0xf0d
        double m_flLastPerfSampleTime; // 0x4f18        
        [[maybe_unused]] std::uint8_t pad_0x4f20[0x4008];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_CSGameRules because it is not a standard-layout class
    static_assert(sizeof(C_CSGameRules) == 0x8f28);
};
