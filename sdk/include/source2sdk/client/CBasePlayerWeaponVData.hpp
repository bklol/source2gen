...
namespace source2sdk::client
{
    ...
    public:
        ...
        CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeCModel>> m_szWorldModel; // 0x28        
        ...
        CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeCModel>> m_sToolsOnlyOwnerModelName; // 0x108        
        ...
        CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_szMuzzleFlashParticle; // 0x210        
        ...
        CUtlOrderedMap<client::WeaponSound_t,CSoundEventName> m_aShootSounds; // 0x320        
    };
    #pragma pack(pop)
