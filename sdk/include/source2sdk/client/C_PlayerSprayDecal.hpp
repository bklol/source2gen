...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xdfd[0xb]; // 0xdfd
        client::CPlayerSprayDecalRenderHelper m_SprayRenderHelper; // 0xe08        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_PlayerSprayDecal because it is not a standard-layout class
    static_assert(sizeof(C_PlayerSprayDecal) == 0xe38);
};
