...
namespace source2sdk::client
{
    ...
    public:
        ...
        CUtlVector<client::CompositeMaterialAssemblyProcedure_t> m_vecCompositeMaterialAssemblyProcedures; // 0x1e0        
        ...
        CUtlVector<client::CompositeMaterial_t> m_vecCompositeMaterials; // 0x1f8        
