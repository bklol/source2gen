...
namespace source2sdk::client
{
    ...
    {
    public:
        client::ParticleIndex_t m_fxSSSunFlareEffectIndex; // 0xd28        
        client::ParticleIndex_t m_fxSunFlareEffectIndex; // 0xd2c        
        ...
        [[maybe_unused]] std::uint8_t pad_0xd66[0x2]; // 0xd66
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(C_Sun) == 0xd88);
};
