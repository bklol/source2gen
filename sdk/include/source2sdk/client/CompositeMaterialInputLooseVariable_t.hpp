...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CompositeMaterialInputLooseVariableType_t m_nVariableType; // 0x40        
        ...
        // metadata: MPropertyFriendlyName "Value"
        // metadata: MPropertyAttrStateCallback
        client::CompositeMaterialVarSystemVar_t m_nValueSystemVar; // 0x90        
        ...
        // metadata: MPropertyAttrStateCallback
        client::CompositeMaterialInputTextureType_t m_nTextureType; // 0x268        
    ...
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strExposedValueList) == 0x38);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nVariableType) == 0x40);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_bValueBoolean) == 0x44);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nValueIntX) == 0x48);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nValueIntY) == 0x4c);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nValueIntZ) == 0x50);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nValueIntW) == 0x54);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_bHasFloatBounds) == 0x58);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatX) == 0x5c);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatX_Min) == 0x60);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatX_Max) == 0x64);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatY) == 0x68);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatY_Min) == 0x6c);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatY_Max) == 0x70);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatZ) == 0x74);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatZ_Min) == 0x78);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatZ_Max) == 0x7c);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatW) == 0x80);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatW_Min) == 0x84);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_flValueFloatW_Max) == 0x88);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_cValueColor4) == 0x8c);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nValueSystemVar) == 0x90);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strResourceMaterial) == 0x98);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strTextureContentAssetPath) == 0x178);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strTextureRuntimeResourcePath) == 0x180);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strTextureCompilationVtexTemplate) == 0x260);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nTextureType) == 0x268);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strString) == 0x270);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_strPanoramaPanelPath) == 0x278);
    static_assert(offsetof(CompositeMaterialInputLooseVariable_t, m_nPanoramaRenderRes) == 0x280);
