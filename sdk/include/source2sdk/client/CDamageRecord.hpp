...
namespace source2sdk::client
{
    ...
    public:
        ...
        CHandle<client::C_CSPlayerPawn> m_PlayerDamager; // 0x28        
        // metadata: MNetworkEnable
        ...
        CHandle<client::C_CSPlayerPawn> m_PlayerRecipient; // 0x2c        
        // metadata: MNetworkEnable
        ...
        CHandle<client::CCSPlayerController> m_hPlayerControllerDamager; // 0x30        
        // metadata: MNetworkEnable
        ...
        CHandle<client::CCSPlayerController> m_hPlayerControllerRecipient; // 0x34        
        // metadata: MNetworkEnable
