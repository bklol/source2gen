...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1b21[0x3]; // 0x1b21
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnUninterruptChanged"
        client::PlayerAnimEvent_t m_nUninterruptableActivity; // 0x1b24        
        [[maybe_unused]] std::uint8_t pad_0x1b28[0x8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_Fists because it is not a standard-layout class
    static_assert(sizeof(C_Fists) == 0x1b30);
};
